...
**Última revisión:** _(fecha)_ · **Responsable:** A
...
**Dónde viven los archivos crudos:** `_______` (fuera del repositorio)

## Encabezado real

<!-- Pega aquí la salida literal de: head -1 archivo.csv
     C2 lo necesita para contrastar contra el diccionario oficial. -->
