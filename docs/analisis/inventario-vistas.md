...
- **Qué contiene:** Los seis indicadores clave. Destaca el volumen en cuarentena con el dato real (3.61% del corpus · 770,273 registros reparados)[cite: 5] y el historial de incidentes (INC-2831 · Deriva de esquema · 18 columnas detectadas vs. 15 esperadas)[cite: 5].
