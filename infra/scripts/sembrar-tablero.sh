...
# tomados de docs/equipo/cronograma.md.
#
# Requisitos:
...
# ─────────────────────────────────────────────────────────────────────────────
TAREAS=$(cat <<'FIN'
1|A|datos|E1 — Definición|3 sep|[S1][Datos] Cerrar la estructura del repositorio|Carpetas con .gitkeep, .gitignore, README inicial, main protegida, los cuatro colaboradores invitados. Crear el tablero en GitHub Projects con las cinco columnas.|Los cinco clonan y ven la misma estructura; git status limpio en las cinco máquinas.|raíz del repositorio
1|A|datos|E1 — Definición|3 sep|[S1][Datos] Localizar y descargar la fuente QQP|Encontrar el conjunto QQP en el portal de PROFECO. Descargar el archivo más reciente y el de 2025. Verificar que abren; anotar tamaño y formato.|Los archivos abren. Tamaño y formato anotados en docs/datos/fuente-qqp.md.|docs/datos/fuente-qqp.md
1|A|datos|E1 — Definición|3 sep|[S1][Datos] Perfilado nivel 1|Contar filas y columnas. Tipos de dato reales por columna. Porcentaje de nulos por columna. Rango de fechas cubierto. Entidades federativas presentes.|Cuaderno de análisis con la tabla de resultados guardado en docs/datos/perfilado/.|docs/datos/perfilado/
1|A|datos|E1 — Definición|4 sep|[S1][Datos] Perfilado nivel 2|Distribución de precios: mínimo, máximo, mediana y percentiles por categoría. Precios en cero, negativos o absurdos. Duplicados exactos. Número de establecimientos y cadenas.|La sección de rangos y anomalías está escrita con números concretos, no con adjetivos.|docs/datos/perfilado/
1|A|datos|E1 — Definición|4 sep|[S1][Datos] Perfilado nivel 3 — variantes de escritura|Tomar veinte productos comunes y contar cuántas formas distintas de escribirlos aparecen entre cadenas. Este número decide si la meta de 85% de cobertura de H3 es realista.|La tabla de variantes por producto está en el perfilado, con el conteo de los veinte productos.|docs/datos/perfilado/
1|A|datos|E1 — Definición|6 sep|[S1][Datos] Informe de perfilado versión cero|Redactar el informe con las tres secciones del perfilado y una conclusión explícita: la fuente sirve, o no sirve, y por qué.|docs/datos/informe-perfilado-v0.md existe y termina con una recomendación clara.|docs/datos/informe-perfilado-v0.md
1|B|infra|E1 — Definición|3 sep|[S1][Infra] docker-compose con los cuatro servicios base|Escribir docker-compose.yml con postgres-oltp, postgres-analytics, minio y adminer. Levantar y verificar que los cuatro responden.|docker compose up levanta los cuatro sin error. MinIO y Adminer abren en el navegador.|docker-compose.yml
1|B|infra|E1 — Definición|4 sep|[S1][Infra] Traefik y enrutamiento local|Agregar Traefik a la composición y resolver el enrutamiento local por nombre de servicio. Crear .env.example con las llaves y valores vacíos.|Los servicios responden por nombre de dominio local en lugar de por puerto.|docker-compose.yml, .env.example
1|B|infra|E1 — Definición|4 sep|[S1][Infra] Integración continua mínima|Configurar el flujo de trabajo para que al abrir una solicitud corra el análisis estático y la compilación.|Una solicitud de prueba dispara la canalización y aparece en verde.|.github/workflows/ci.yml
1|B|infra|E1 — Definición|4 sep|[S1][Infra] Cuentas de Oracle Cloud y GitHub Student Pack|Registrarse en Oracle Cloud y solicitar el GitHub Student Pack. Ambos trámites tardan, por eso van la primera semana.|Ambos registros enviados, con captura del acuse en el issue.|—
1|C1|dominio|E1 — Definición|3 sep|[S1][Dominio] Esqueleto de Spring Boot con las tres capas|Instalar JDK 21 y Maven. Crear el proyecto con las tres capas separadas y exponer un endpoint de salud.|GET /health responde. El servicio arranca con mvn spring-boot:run.|services/domain-service/
1|C1|dominio|E1 — Definición|4 sep|[S1][Dominio] Primer borrador del modelo de dominio|Definir qué son entidades, qué son objetos de valor y dónde están los límites de los agregados Usuario, Canasta y Alerta.|Existe docs/analisis/modelo-dominio.md con la lista y su justificación.|docs/analisis/modelo-dominio.md
1|C2|movil|E1 — Definición|3 sep|[S1][Móvil] Diccionario de datos de QQP|Descargar y leer el diccionario de datos de QQP. Anotar qué columnas existen y qué significa cada una.|Existe docs/datos/diccionario-qqp.md con la lista de columnas y su significado.|docs/datos/diccionario-qqp.md
1|C2|movil|E1 — Definición|4 sep|[S1][Móvil] Proyecto base de Expo corriendo|Instalar Node 20 y Expo. Crear el proyecto y dejarlo arrancando en un teléfono real o emulador, con navegación entre dos pantallas vacías.|La app abre en un teléfono. Captura adjunta en el issue.|clients/mobile/
1|D|web|E1 — Definición|3 sep|[S1][Web] Inventario de las ocho vistas|Crear el archivo de Figma del proyecto. Escribir el inventario de las ocho vistas con una línea de contenido por cada una.|El enlace de Figma está en el README y el inventario en docs/analisis/inventario-vistas.md.|docs/analisis/inventario-vistas.md
1|D|web|E1 — Definición|4 sep|[S1][Web] Wireframe del tablero analítico|Wireframe de baja fidelidad: qué gráficas van, en qué orden y con qué filtros.|El wireframe existe en Figma y se ve desde el enlace compartido.|Figma
1|D|web|E1 — Definición|4 sep|[S1][Web] Wireframe de la consola de observabilidad|Wireframe de la consola. Se revisa con A antes de darlo por bueno, porque los seis indicadores tienen que leerse de un vistazo.|El wireframe existe y A dio su visto bueno por escrito en este issue.|Figma
1|A|entrega|E1 — Definición|7 sep|[S1][Equipo] Reunión de decisión y ADR de la fuente|Reunión de 45 minutos. A presenta el perfilado. El equipo decide si la fuente sirve y fija el recorte geográfico con datos en mano. Se acuerda el horario fijo de la reunión semanal.|docs/adr/001-fuente-de-datos.md escrito con fecha, contexto, decisión y alternativas descartadas. Horario de reunión en el calendario de los cinco.|docs/adr/001-fuente-de-datos.md
2|A|datos|E1 — Definición|13 sep|[S2][Datos] Contrato de datos v1 para QQP|Escribir el contrato en YAML: columnas, tipos, obligatoriedad, rangos y umbral de frescura.|El archivo existe en contracts/ y Pandera lo carga sin error.|contracts/
2|A|datos|E1 — Definición|13 sep|[S2][Datos] Primer guión de ingesta a MinIO|Guión que descarga el archivo de PROFECO y lo guarda como Parquet particionado en MinIO.|El guión corre de principio a fin y el Parquet aparece en el bucket.|services/data-platform/ingestion/
2|B|infra|E1 — Definición|13 sep|[S2][Infra] Separar entornos y manejo de secretos|Separar los entornos de desarrollo y pruebas. Configurar el manejo de secretos. Extender la integración continua para que corra pytest.|Los dos entornos levantan por separado y la canalización corre pytest en verde.|infra/envs/, .github/workflows/
2|C1|dominio|E1 — Definición|13 sep|[S2][Dominio] Cerrar el modelo y estructurar el servicio|Definir atributos de cada entidad y las reglas de negocio dentro del agregado. Estructurar el servicio en capas. Implementar Usuario y Canasta con sus reglas.|El documento del modelo está completo. Las clases de Usuario y Canasta existen con sus reglas y compilan.|docs/analisis/, services/domain-service/
2|C2|movil|E1 — Definición|13 sep|[S2][Móvil] Navegación con las cuatro pantallas|Navegación completa de la app con las cuatro pantallas vacías: búsqueda, detalle, mi canasta, alertas.|Se navega entre las cuatro pantallas en el teléfono. Video corto adjunto.|clients/mobile/
2|D|web|E1 — Definición|13 sep|[S2][Web] Sistema de diseño mínimo y ocho wireframes|Definir paleta, tipografía y componentes base en Figma. Aplicarlos a los wireframes existentes y completar los de las ocho vistas.|El sistema de diseño está en Figma y las ocho vistas lo usan.|Figma
...
echo "  3. Mueve a 'Esta semana' lo que toca del 3 al 7 de septiembre."
echo "  4. Las semanas 4 en adelante se siembran en la reunión semanal, no ahora."
